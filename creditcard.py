...
if __name__ == '__main__':
    wallet = []
    wallet.append(CreditCard('Omkar','ICICI Bank','1245 7896 8574 3214',55000))
    wallet.append(CreditCard( 'Shyam' , 'ANZ Bank' ,'3656 5487 9685 4512' , 40000))
    wallet.append(CreditCard( 'Mohan' , 'ICICI Bank' , '4565 8597 6985 3256' , 50000))
    for c in range(3):
